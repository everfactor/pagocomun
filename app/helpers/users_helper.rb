module UsersHelper
  ...
  def organization_select_config(require_organization: false)
    ...
    select_attributes = {
      class: "block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm"
    }
